<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main" style="background-color: #D3EEEE;">
    <div class="sidenav-header">
        <a class="navbar-brand d-flex align-items-center m-0">
                <img src="../assets/img/logo.png" class="image" alt="image" width="100"/>
            </a>
    </div>
    <div class="collapse navbar-collapse px-4 w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}" style="background-color: #006769;">
